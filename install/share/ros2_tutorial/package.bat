...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ros2_tutorial\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ros2_tutorial\hook\ament_prefix_path.bat"
